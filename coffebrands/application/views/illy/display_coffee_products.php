        ...
        <div class="col-sm-4" style="border-color: #2f2f2f">
            ...
            <div class="col-sm-6 thumbnail "  style=" background-color: whitesmoke;border-color#2f2f2f;">
                ...
                <div class="caption">
                    ...
                    <img src="<?php echo base_url().'/'.$product['product_image']?> "class="img-responsive" style="height:30%">
                    ...
                    echo form_open('illy/Cart_system/add_cart_item');
...
<script type="text/javascript">
    ...
    function ajaxSearch() {
        ...
        if (input_data.length === 0) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>illy/Search/find_coffee/",
                data: post_data,
